...
function handleSubscribedType(obj)
{
  switch(obj.type_id)
  {
    ...
    case cacheTypeIDs.LOBBY:
      ...
      var lobby = schema.CSODOTALobby.decode(obj.object_data[0]);
    ...
    case cacheTypeIDs.PARTY:
      ...
      var party = schema.CSODOTAParty.decode(obj.object_data[0]);
    ...
    case cacheTypeIDs.PARTY_INVITE:
      ...
      var party = schema.CSODOTAPartyInvite.decode(obj.object_data[0]);
...
Dota2.Dota2Client.prototype._handleWelcomeCaches = function handleWelcomeCaches(message)
{
    ...
    // var d = schema.CMsgClientWelcome.decode(message);
    // console.log(d);
    
  //var welcome = gcsdk_gcmessages.CMsgClientWelcome.parse(message);
  var welcome = schema.CMsgClientWelcome.decode(message);
  var _self = this;
...
handlers[Dota2.ESOMsg.k_ESOMsg_CacheSubscribed] = function onCacheSubscribed(message) {
  ...
  var subscribe = schema.CMsgSOCacheSubscribed.decode(message);
  var _self = this;
...
handlers[Dota2.ESOMsg.k_ESOMsg_UpdateMultiple] = function onCacheSubscribed(message) {
  ...
  var multi = schema.CMsgSOMultipleObjects.decode(message);
  var _self = this;
...
handlers[Dota2.ESOMsg.k_ESOMsg_CacheUnsubscribed] = function onCacheUnsubscribed(message) {
  ...
  var unsubscribe = schema.CMsgSOCacheUnsubscribed.decode(message);
  var _self = this;
...
handlers[Dota2.ESOMsg.k_ESOMsg_CacheDestroy] = function onCacheDestroy(message) {
  ...
  var destroy = schema.CMsgSOSingleObject.decode(message);
  var _self = this;
