...
UserCollection.prototype.get = function (accountId, callback, personaName) {
    var self = this;
...
UserCollection.prototype.getRank = function (accountId, callback) {
    var self = this;
...
UserCollection.prototype.giveUserPoints = function (accountId, personaName, pointReward) {
...
UserCollection.prototype.updateUserStreak = function (accountId, streak) {
    var self = this;
    this.get(accountId, function (user) {
